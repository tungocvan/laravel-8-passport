          ...
          <tbody class="list" id="deal-tables-body">
            @foreach ($data as $key => $item)
                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="phone align-middle white-space-nowrap fw-semi-bold text-1000 ps-4 border-end">{{getGroupName($item['group_id'])}}</td>
                    <td class="phone align-middle white-space-nowrap fw-semi-bold text-1000 ps-4 border-end">{{$item['created_at']}}</td>
